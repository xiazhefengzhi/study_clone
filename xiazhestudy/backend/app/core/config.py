...
class Settings(BaseSettings):
    ...
    # GCP Vertex AI (Primary - Gemini 3.0)
    GCP_PROJECT_ID: str = ""
    GCP_LOCATION: str = "global"
    GCP_MODEL_NAME: str = "google/gemini-3-pro-preview"
    LLM_TEMPERATURE: str = "1"

    # GCP OAuth Credentials (for deployment)
    GCP_CLIENT_ID: str = ""
    ...
    OPENROUTER_MODEL: str = "google/gemini-2.5-flash-preview-09-2025"
    ...
    # 注意：现在使用 Supabase Storage，以下本地存储配置已废弃
    # UPLOAD_DIR: str = os.path.join(os.getcwd(), "static", "uploads")  # 已废弃
    # BASE_URL: str = "http://localhost:8000"  # 已废弃
...
# 注意：现在使用 Supabase Storage，不再需要创建本地上传目录
# os.makedirs(settings.UPLOAD_DIR, exist_ok=True)  # 已废弃
